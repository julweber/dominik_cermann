	...
	if( jQuery().isotope ) {
		...
		function reorganizeIsotope() {
			jQuery('.masonry').each(function(){
				...
				var itemmargin = 0; //parseInt($container.children('div').css('marginRight')) + parseInt($container.children('div').css('marginLeft'));
				var rows = 1; //Math.ceil(containerwidth/maxitemwidth);
